...
const Resume = () => (
  <Layout>
    ...
    <div className="resume__wrapper">
      ...
      <h3>Technologies</h3>
      <p>JavaScript, jQuery, HTML5, CSS3, Git, REST/SOAP APIs, Ajax, SQL, Email Service Provider API’s,PHP, Reactjs, Agile Methodologies, Gatsbyjs, Contentful</p>
      <h3>Experience</h3>
      <p className="resume__job-title">Fullstack Developer, Buffy, NY, NY – Nov 2019-Feb-2020</p>
      <ul>
        <li>Helped maintain Shopify site using Liquid and jQuery.</li>
        <li>Helped refactor old redundant code.</li>
