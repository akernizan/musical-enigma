...
const Resume = () => (
  <Layout>
    ...
    <div className="resume__wrapper">
      ...
      <h3>Technologies</h3>
      <p>JavaScript, jQuery, HTML5, CSS3, Sass, Git, REST/SOAP APIs, Ajax, SQL, Email Service Provider API’s, PHP, Reactjs, Agile Methodologies, Gatsbyjs, Contentful, Selenium, Cypress, Jira, TDD, Github</p>
